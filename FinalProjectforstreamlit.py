...
st.sidebar.markdown("<h1 style='text-align: left; color: red; font-family: Arial, sans-serif; margin-top: -30px; margin-bottom: 20px;'>Go to</h1>", unsafe_allow_html=True)
